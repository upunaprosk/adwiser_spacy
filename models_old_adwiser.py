...
def models_old(user_input, test):
    ...
    def tester(function, datum):
        result = ''
        exec('result = {function}(datum)')
        return result
    if test:
...
def main():
    ...
    m = models_old('There have been little cheese. I have a little daughter.', False)
    print(m)
